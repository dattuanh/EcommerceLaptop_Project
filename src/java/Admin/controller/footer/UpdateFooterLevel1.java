 ...
 * @author admin
 */
@WebServlet(name="UpdateFooterLevel1", urlPatterns={"/UpdateFooterLevel1"})
public class UpdateFooterLevel1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateFooterLevel1</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateFooterLevel1 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
