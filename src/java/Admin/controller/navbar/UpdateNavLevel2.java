 ...
 * @author admin
 */
@WebServlet(name = "UpdateNavLevel2", urlPatterns = {"/UpdateNavLevel2"})
public class UpdateNavLevel2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateNavLevel2</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateNavLevel2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<News> nav = dao.getAllNavBars();
        ...
        for (News n : nav) {
            ...
            if (Ids != null) {
                ...
                NewsGroup temp = dao.getNavBarLevel_1(t.getNewTitle());
                News c = new News();
