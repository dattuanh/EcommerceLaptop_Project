...
//        int modifiedBy = Integer.parseInt(request.getParameter("Account"));
        ...
        String modifiedHistory = Base.Util.Formatter.getCurrentDate().toString() + " - " + Base.Util.Utilities.getLoggingInAccount(request, response).getUserName() + ": Update Category <br>";
