...
public class CustomerManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = daoCustomer.countSearch("");
        ...
        List<Customer> customerList = daoCustomer.searchCustomerBy("", indexPage, entries, "");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String searchQuery = daoCustomer.getAllCustomerByFilter(filter, search);

        // total elements searched
        int count = daoCustomer.countSearch(searchQuery);
        ...
        // showed list
        List<Customer> customerList = daoCustomer.searchCustomerBy(searchQuery, index, entry, "");
        ...
        if (customerList != null) {
            ...
            for (Customer c : customerList) {
                out.print("<tr>\n"
                        ...
                        + "                                                                            <input type='checkbox' class=\"form-check-input\" name=\"Ids[]\" value=\"" + c.getCustomerId() + "\">\n"
                        + "<i class=\"input-helper\"></i>"
                        + "                                                                        </label>\n"
                        + "                                                                    </div>\n"
                        + "                                                                </td>\n"
                        + "<td class=\"py-1\"> \n"
                        + "                                                                    <img src=\"images/Customer/" + c.getImage() + "\" \n"
                        ...
                        + "                                                                <td>\n"
                        + "                                                                    &nbsp;\n"
                        + "                                                                    <a href=\"UpdateCustomer?id=" + c.getCustomerId() + "\">\n"
                        + "                                                                        <i class=\"mdi mdi-lead-pencil\" style=\"font-size: 22px\"></i>\n"
                        + "                                                                    </a>\n"
                        + "                                                                    &nbsp;\n"
                        + "                                                                    <i class=\"mdi mdi-delete\" style=\"font-size: 22px; color: #1079eb\" \n"
                        + "                                                                       onclick=\"confirmDelete('DeleteCustomer', " + c.getCustomerId() + ")\">\n"
                        + "                                                                    </i>"
                        + "                                                                </td>\n"
                        + "                                                            </tr>");
            }

            out.print("<td colspan=\"10\" style=\"border-left: hidden; border-right: hidden; border-bottom: hidden\" >\n"
