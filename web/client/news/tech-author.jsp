<%-- 
    Document   : tech-author
    Created on : May 24, 2023, 11:28:48 AM
    Author     : MSI
--%>
...
<html lang="en">
    ...
    <!-- Site Metas -->
    <title>${acc.firstName} ${acc.lastName}</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-star bg-orange"></i> Tác giả: ${acc.firstName} ${acc.lastName}</h2>
                    </div><!-- end col -->
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="indexnews">Home</a></li>
                            <!--                            <li class="breadcrumb-item"><a href="#">Author</a></li>-->
                            <li class="breadcrumb-item active">${acc.firstName} ${acc.lastName}</li>
                        </ol>
                    </div><!-- end col -->                    
                </div><!-- end row -->
            </div><!-- end container -->
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <h4><a href="#">${acc.firstName} ${acc.lastName}</a></h4>
                                ...
                                <c:forEach items="${listNews}" var="c">
                                    <div class="blog-box row">
                                        ...
                                        <div class="blog-meta big-meta col-md-8">
                                            ...
                                            <p>${c.newsHeading}</p>
                                            <small class="firstsmall"><a class="bg-orange" href="TechCategoryControl/${SlugConverter.convertToSlug(c.newsGroupID.newsGroupName.replaceAll(" ","-"))}-${c.newsGroupID.newsGroupID}.html" title="">${c.newsGroupID.newsGroupName}</a></small>
