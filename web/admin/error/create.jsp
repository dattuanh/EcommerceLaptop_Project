                        ...
                        <div class="content-wrapper" style="padding-top: 5%">
                            <div class="row">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="forms-sample mt-3 row" action="CreateErrors" method="post">

                                                <div class="col-sm-8">
                                                    <div class="form-group row">
                                                        <label for="errorMessage" class="col-sm-3 col-form-label">Nội dung lỗi</label>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input type="text" class="form-control" id="errorsMessage" placeholder="Tên lỗi" name="errorsMessage">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <jsp:include page="../Util/Format.jsp"></jsp:include>
                                                            <input type="text" class="form-control" id="RepairPrice" placeholder="Phí sửa chữa" 
                                                                   ...
                                                                   onkeyup="formatCurrency(this, '');" placeholder="VND #,###.00"
                                                                   >
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <c:forEach var = "i" begin = "1" end = "4">
                                                                <option value="${i}"><%=(String) RepairStatusEnum.getRepairStatusString(j++)%></option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div>
                                                <button type="submit" class="btn btn-primary mr-2">Create Error</button>
