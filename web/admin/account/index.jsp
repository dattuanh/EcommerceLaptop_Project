...
<%--<%@ taglib uri="http://commons.apache.org/proper/commons-lang/jsp/jstl/functions" prefix="fn" %>--%>
                            ...
                            <div class="row ">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="nav-link mt-2 mt-md-0 d-none d-lg-flex search mx-auto">
                                                    ...
                                                    <button type="button" class="col-md-1 btn btn-primary btn-fw check-all-submit-btn disabled"
                                                            style="margin-right: 10px">Remove Account</button>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="search" name="search" placeholder="Search Account" value="${search}" autofocus>
                                                </div>

                                                <a type="submit" href="AccountManagement" class="btn btn-light col-md-1" 
                                                   style="line-height: unset; margin-right: 10px">
                                                    <i class="mdi mdi-reload"></i>
                                                </a>

                                                <a href="CreateAccount" class="col-md-2 btn btn-primary"
                                                   style="line-height: inherit">
                                                    <!--<button type="button" class="col-md-2 btn btn-primary btn-rounded btn-fw">New Account</button>-->
                                                    New Account
                                                </a>
                                            </div>
                                        ...
                                        <form id="delete" class="" name="deleteAll-form" method="post" action="DeleteAccount">
                                                ...
                                                <table class="table">
                                                                ...
                                                                <td>
                                                                    <div class="form-check form-check-muted m-0">
                                                                        <label class="form-check-label">
                                                                            <input type="checkbox" class="form-check-input" name="Ids[]" value="${a.accountId}">
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td> 
                                                                    <!--<a href="AccountRolesManagement?id=${a.accountId}"> ${a.userName} </a>-->
                                                                    ${a.userName}
                                                                </td>
                                                                <td id="HidePass" onclick="ShowHidePass(<%=i%>)"> 
                                                                    <i id="i<%=i%>" class="mdi mdi-barcode" style="font-size: 22px"></i>
                                                                    <p id="p<%=i++%>" style="display: none">
                                                                        ${a.password}
                                                                    </p>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <td colspan="10">
                                                        <nav aria-label="Page navigation">
                                                            <p> There are ${accountList.size()} / ${listSize} Customers</p>
