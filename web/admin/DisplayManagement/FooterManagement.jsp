...
//alert("HE");
                ...
                function removeFooterLevel1(id) {
                    document.getElementById("removeFooterId1").value = id;
                    document.getElementById("removeFooterLevel1").submit();

                }

                function removeFooterLevel2(id) {
                    document.getElementById("removeFooterId2").value = id;
                    document.getElementById("removeFooterLevel2").submit();
                    ...
                    <div class="main-panel">
                            ...
                            <div class="row ">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <h3 class="card-title col-10">Footer Edit</h3>
                                                <h9 style="color: #cccccc"> This page allow user with roles to edit the display of the Footer</h9>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link btn btn-success shadow-none active" id="infor-tab" data-bs-toggle="tab" data-bs-target="#infor" type="button" role="tab" aria-controls="infor" aria-selected="true"><h6>Footer Edit Level 1</h6></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link btn btn-secondary shadow-none" id="history-tab" data-bs-toggle="tab" data-bs-target="#history" type="button" role="tab" aria-controls="infor" aria-selected="true"><h6>Footer Edit Level 2</h6></button>
                            </li>
                        </ul>
                        <div class="tab-content card" id="myTabContent">
                            <div class="tab-pane fade show active" id="infor" role="tabpanel" aria-labelledby="home-tab">
                                <form class="form-group row" action="CreateFooterLevel1" method="POST" style="padding: auto auto">
                                    <label class="col-sm-12 col-form-label"><h3>New Footer Button</h3> </label>
                                    <div class="col-sm-2">
                                        <label for="Link" class="col-form-label"><h5>Footer Name: </h5> </label>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="navName" placeholder="Name" name="navName">
                                    </div>
                                    <input type="hidden" name="pos" value="${dao.getAllFooters().size()}">
                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-primary">Add Footer</button>
                                    </div>
                                </form>
                                <form action="UpdateFooterLevel1" method="POST">
                                    <div id="simple-list" class="row">
                                        <label class="col-sm-12 col-form-label">
                                            <h3>Footer Edit Level 1</h3>
                                            <h9 style="color: #cccccc"> Drag and Drop Heading to rearrange order</h9>
                                        </label>
                                        <div class="nav nav-tabs editNav-item" style="padding-left: 50px; border: none; margin-top: 50px;">
                                            <c:forEach items="${dao.getAllFooters()}" var="nav" varStatus="loop">
                                                <div id="${nav.newId}" draggable="true" class="box" style="border:">
                                                    <div class="nav-item nav-link btn btn-light shadow-none active" >
                                                        ...
                                                        <h6>${dao.getFooterLevel_1(nav.newTitle).newsGroupName}
                                                            <span onclick="removeFooterLevel1(${nav.newId})" style=" margin-left: 20px; position: relative" class="close">&times;</span>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </c:forEach>
                                ...
                                <form id="removeFooterLevel1" hidden action="RemoveFooterLevel1" method="POST">
                                    <input type="hidden" id="removeFooterId1" name="removeFooterId" value="">
                                </form>
                            </div>
                            <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
                                <form class="form-group row" id="todo-form">
                                    <label class="col-sm-12 col-form-label"><h3>New Sub Footer Link</h3> </label>
                                    <div class="col-sm-1">
                                ...
                                <div id="simple-list" >
                                    <label class="row col-form-label">
                                        <h3 class="col-sm-12">Footer Edit Level 2</h3>
                                        <h9 class="col-sm-12" style="color: #cccccc"> Drag and Drop Button to rearrange order</h9>
                                    </label>
                                    <form action="UpdateFooterLevel2" method="POST">

                                        <div id="level2" class="lanes row">

                                            <c:forEach items="${dao.getAllFooters()}" var="nav" varStatus="loop">
                                                <div id="${nav.newId}" class="swim-lane col-3">
                                                    <c:set var="footer" value="${dao.getFooterLevel_1(nav.newTitle)}"/>
                                                    <h3 class="heading">${footer.newsGroupName}</h3>
                                                    <c:forEach items="${dao.getAllFooterLevel_2(footer.newsGroupID)}" var="n" varStatus="loop">
                                                        <p class="task" draggable="true">
                                                            ${n.newTitle}
                                                            <span onclick="removeFooterLevel2(${n.newId})" class="close">&times;</span>
                                    ...
                                    <form id="removeFooterLevel2" hidden action="RemoveFooterLevel2" method="POST">
                                        <input type="hidden" id="removeFooterId2" name="removeFooterId" value="">
                                    </form>
                                </div>
                            </div>
                        </div>
