                            ...
                            <div class="row ">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        ...
                                        <form class="forms-sample mt-3" action="UpdateProduct" method="post">   
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <c:if test="${selectedProduct.status == false}">
                                                        <input type="radio" name="status" value="true"> Sold 
                                                    ...
                                                    <c:if test="${selectedProduct.status == true}">
                                                        ...
                                                        <input type="radio" name="status" value="false"> Available </td>
                                                    </c:if>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control"  name="batch" value="${selectedProduct.batchSerial}"> 
                                                </div>
                                            </div>
