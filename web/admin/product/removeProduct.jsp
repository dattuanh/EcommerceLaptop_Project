                            ...
                            <div class="row ">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        ...
                                        <form class="forms-sample mt-3" action="RemoveProduct" method="post">   
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">                          
                                                    <c:if test="${selectedProduct.status == false}">
                                                        <input type="radio" name="status" value="false" checked="checked" readonly> Available </td>
                                                    </c:if>
                                                    <c:if test="${selectedProduct.status == true}">
                                                        <input type="radio" name="status" value="true" checked="checked" readonly> Sold 
                                                    </c:if>
                                                </div>
                                            </div>
