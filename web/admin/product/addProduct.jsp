                        ...
                        <div class="content-wrapper" style="padding-top: 5%">
                            <div class="row">
                                <div class="col-md-6 grid-margin stretch-card mx-auto">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="forms-sample mt-3" action="AddProduct" method="post">
                                            <c:if test="${not empty selectedSerie}" >
                                            ...
                                            <div class="form-group row">
                                                <label for="Stock" class="col-sm-3 col-form-label">Batch Serial </label>
                                                <div class="col-sm-9">
