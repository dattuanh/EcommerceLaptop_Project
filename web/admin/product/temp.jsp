            ...
            <script>
                function searchProduct() {
                    ...
                    $.ajax({
                        ...
                        data: {search: search, filter: filter, entry: entry, serieId: serieId},
                        type: "POST",
                ...
                function searchPage(index) {
                    ...
                    $.ajax({
                        url: "ProductManagement",
                        data: {search: search, filter: filter, index: index, entry: entry, serieId: serieId},
                        type: "POST",
                        success: function (data) {
                            var searchList = document.getElementById('content');
                            searchList.innerHTML = data;
                    ...
                    <div class="main-panel">
                        ...
                        <div class="tab-content card" id="myTabContent">
                                    ...
                                    <div class="form-group row">
                                        <div class="col col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <img src="admin/assets/shared/images/Seri/${selectedSerie.imagePreview}" onerror="this.onerror=null;this.src='admin/assets/shared/images/others/img-14.jpg';" style="max-width: 100%; max-height: 300px" />
                                                </div>
                                                <label for="Image" class="col-sm-12 col-form-label">Detail Image</label>
                                                <c:forEach items="${imageList}" var="i">
                                                    <div class="col-sm-3">
                                                        <img class="col-sm-12" src="assets/shared/images/Seri/${i.imageName}" onerror="this.onerror=null;this.src='assets/shared/images/others/img-14.jpg';" style="max-width: 100%; max-height: 300px" />
                                                        <!--<label class="col-sm-12 col-form-label">${i}</label>-->
                                                    </div>
                                                </c:forEach>
                                            </div>
                                        </div>
                                        <div class="col col-md-6">
                                            <div class="form-group row">
                                                <label for="SerieName" class="col-sm-3 col-form-label">Series Name: </label>
                                                <div class="col-sm-9">
                            ...
                            <div class="tab-pane fade" id="client" role="tabpanel" aria-labelledby="client-tab">
                                <iframe src="http://localhost:9999/EcommerceLaptopSale/SerieDetail?serieId=${selectedSerie.productSeriId}" width="100%" height="750"></iframe>
                            </div>
                        </div>
                    </div>
